...
for i in $t
	...
	sed -i "s/addQueueWeights 0 50/addQueueWeights 0 50/" simul1.tcl
	sed -i "s/addQueueWeights 1 50/addQueueWeights 1 100/" simul1.tcl
	sed -i "s/addQueueWeights 2 50/addQueueWeights 3 150/" simul1.tcl
