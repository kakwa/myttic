...
$ns queue-limit $nred $ndest 2900000
...
$q0n1 addPolicyEntry [$n1 id] [$ndest id] TokenBucket 10 40000000 75000
$q0n1 addPolicyEntry [$n2 id] [$ndest id] TokenBucket 10 40000000 75000
$q0n1 addPolicyEntry [$n3 id] [$ndest id] Null 11
$q0n1 addPolicerEntry TokenBucket 10 12
...
$q0n1 setMREDMode RIO-C 0
$q0n1 setMREDMode RIO-C 1
$q0n1 setMREDMode RIO-C 2



$q0n1 configQ 0 0 290 290 1
$q0n1 configQ 1 0 290 290 1
$q0n1 configQ 2 0 0 0 1
