...
for i in $tr
	...
	sed -i "s/addQueueWeights 0.*/addQueueWeights 0 1/" simul1.tcl
	sed -i "s/addQueueWeights 1.*/addQueueWeights 1 1/" simul1.tcl
	sed -i "s/addQueueWeights 2.*/addQueueWeights 2 1/" simul1.tcl
