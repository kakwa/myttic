...
set intervalle_trace 5
set intervalle_relance 5
#################### PARAM #################
proc finish {} {
...
$ns simplex-link $n1 $nred 9999999999Mb $delay DropTail
$ns queue-limit $n1 $nred 9999999
$ns simplex-link $n2 $nred 9999999999Mb $delay DropTail
$ns queue-limit $n2 $nred 9999999
$ns simplex-link $n3 $nred 9999999999Mb $delay DropTail
$ns queue-limit $n3 $nred 9999999
...
$q0n1 configQ 0 0 1000 10000 1
$q0n1 configQ 1 0 1000 10000 1
$q0n1 configQ 2 0 1000 10000 1

$q0n1 setSchedularMode WRR
$q0n1 addQueueWeights 0 50
$q0n1 addQueueWeights 1 50
$q0n1 addQueueWeights 2 50
...
$donnees1 set packetSize_ 400
$donnees2 set packetSize_ 4000
$donnees3 set packetSize_ 12000

set video [new Agent/UDP]	
$video set fid_ 2

$video set packetSize_ 8000

set voix [new Agent/UDP]	

$voix set packetSize_ 800
$voix set fid_ 3
...
$poisson3 set packetSize_ 12000
...
$exp set packetSize_ 8000
$exp set burst_time_ 1ms
$exp set idle_time_ 2ms
$exp set rate_ 90Mb
...
puts $tf1 "[$ns now] [$monitor set pdrops_] [$monitor set parrivals_] [$mon_donnee set parrivals_] [$mon_donnee set pdrops_]"
